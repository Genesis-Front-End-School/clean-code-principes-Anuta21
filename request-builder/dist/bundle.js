(function (global, factory) {
  ...
  class RequestBuilder {
      ...
      setHeaders(headers) {
          this.requestOptions.headers = Object.assign(Object.assign({ "Content-Type": "application/json; charset=utf-8", Accept: "application/json, text/plain, */*" }, this.requestOptions.headers), headers);
          return this;
      }
      ...
      get(path) {
          return axiosInstance.get(path, this.requestOptions);
      }
  }
